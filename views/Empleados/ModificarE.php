...
?>
	<div class="cuerpo">
		<form method="POST" action="../../mc/Controll/ModificarEmpleado.php">
			<center><label for="TipoDocUsuario">Digite el numero de documento del usuario:</label>
			<input type="number" name="TipoDocUsuario" required></center>
		</form>
	</div>
	<br>
<?php
