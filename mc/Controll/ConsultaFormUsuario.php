...
?>
	<div class="cuerpo"> 
		<form method="POST" action="../../msql/Empleados/ConsultaFormUsuario.php">
		...
		<?php
			...
			if ($resultado -> num_rows > 0) { //condicion que compara el numero de filas contenidas en la variable resultado con 0
					...
					while ($row = $resultado->fetch_assoc()) { // ciclo que extrae los datos de resultado convirtiendolo en un array llamado row
						...
						//inicia tabla que presenta las variables obtenidas en el array
						echo "<table>  
								<tr>
								...
								<tr>
									<td><center>&#127924 Foto del usuario:</center>	
									<center> <img width='100' src='data:image/png;base64, $fotoUsuario'></td>
							...
							<center><a href='../../Inicio.php'><input type='image' src='../../estilos/Imagenes/1x/Volver.png' onMouseOver=this.src='../../estilos/Imagenes/1x/VolverOnClick.png' onMouseOut=this.src='../../estilos/Imagenes/1x/Volver.png' class='registrar'></a></center>";
